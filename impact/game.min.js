...
// lib/game/entities/qubber.js
ig.baked=true;ig.module('game.entities.qubber').requires('impact.entity').defines(function(){EntityQubber=ig.Entity.extend({type:ig.Entity.TYPE.A,checkAgainst:ig.Entity.TYPE.B,collides:ig.Entity.COLLIDES.ACTIVE,animSheet:new ig.AnimationSheet('media/sprite_girl2.png',32,35),size:{x:32,y:35},flip:true,accelGround:200,accelAir:310,jump:360,friction:{x:500,y:500},maxVel:{x:160,y:160},money:0,init:function(x,y,settings){this.parent(x,y,settings);this.addAnim('idle',0.2,[0,1,2,3,4,5]);this.addAnim('run',0.1,[6,7,8,9,10,11]);},update:function(){var accel=this.accelAir;if(ig.input.state('left')){this.accel.x=-accel;this.flip=true;}else if(ig.input.state('right')){this.accel.x=accel;this.flip=false;}else
this.accel.x=0;if(ig.input.state('up')){this.accel.y=-accel;}else if(ig.input.state('down')){this.accel.y=accel;}else{this.accel.y=0;}
this.currentAnim.flip.x=this.flip;this.parent();if(this.vel.x!=0|this.vel.y!=0)
this.currentAnim=this.anims.run;else
this.currentAnim=this.anims.idle;},check:function(other){if(other.id==1){other.id=0;console.log("hit correct house");other.athouse=true;this.money+=100;}}});});

// lib/game/entities/house.js
ig.baked=true;ig.module('game.entities.house').requires('impact.entity').defines(function(){EntityHouse=ig.Entity.extend({type:ig.Entity.TYPE.B,checkAgainst:ig.Entity.TYPE.NONE,collides:ig.Entity.COLLIDES.FIXED,animSheet:new ig.AnimationSheet('media/house.png',32,32),size:{x:32,y:32},flip:true,friction:{x:500,y:500},maxVel:{x:0,y:0},athouse:false,init:function(x,y,settings){this.parent(x,y,settings);this.addAnim('idle',1,[2]);this.addAnim('hit',0.1,[2,6,10]);},update:function(){this.parent();if(this.athouse){this.currentAnim=this.anims.hit;}else{this.currentAnim=this.anims.idle;}},});});

// lib/game/levels/qubmap.js
ig.baked=true;ig.module('game.levels.qubmap').requires('impact.image','game.entities.qubber','game.entities.house').defines(function(){LevelQubmap={"entities":[{"type":"EntityQubber","x":520,"y":344},{"type":"EntityHouse","x":484,"y":256},{"type":"EntityHouse","x":224,"y":160},{"type":"EntityHouse","x":224,"y":224},{"type":"EntityHouse","x":220,"y":400},{"type":"EntityHouse","x":392,"y":160},{"type":"EntityHouse","x":164,"y":80},{"type":"EntityHouse","x":92,"y":280}],"layer":[{"name":"main","width":30,"height":20,"linkWithCollision":false,"visible":1,"tilesetName":"media/woodland.png","repeat":false,"preRender":false,"distance":"1","tilesize":32,"foreground":false,"data":[[2,2,36,2,2,2,36,2,2,2,36,2,2,2,36,2,2,2,2,2,4,2,2,2,2,36,2,2,2,5],[20,2,36,2,2,2,36,2,2,5,36,2,2,2,36,2,2,2,2,2,2,2,2,2,2,36,2,2,2,2],[2,2,36,20,2,2,36,2,2,2,36,4,2,2,36,2,2,2,2,2,2,20,2,2,2,36,2,2,2,2],[2,2,36,2,2,2,36,2,2,2,36,2,2,2,36,2,2,2,5,2,2,2,2,2,2,36,2,5,2,2],[2
init:function(x,y,settings){this.parent(x,y,settings);this.addAnim('idle',1,[7]);this.addAnim('clicked',0.2,[0,1,2,3,4,5,6,7,8]);},update:function(){if(ig.input.pressed('leftMouse')&&this.inFocus()){if(this.open){this.open=false;this.currentAnim=this.anims.idle;}else{ig.log('clicked');this.currentAnim=this.anims.clicked;this.open=true;}}
this.parent();},draw:function(){this.parent()
if(this.open){}},inFocus:function(){return((this.pos.x<=(ig.input.mouse.x+ig.game.screen.x))&&((ig.input.mouse.x+ig.game.screen.x)<=this.pos.x+this.size.x)&&(this.pos.y<=(ig.input.mouse.y+ig.game.screen.y))&&((ig.input.mouse.y+ig.game.screen.y)<=this.pos.y+this.size.y));},});});

// lib/game/controllers/sceneController.js
ig.baked=true;ig.module('game.controllers.sceneController').requires('impact.impact').defines(function(){ig.sceneController=ig.Class.extend({init:function(theGame,initialLevels){this.game=theGame;this.levels=[];this.currentLevel=0;this.append(initialLevels);return this.loadLevel(this.currentLevel);},loadLevel:function(levelNumber){this.currentLevel=levelNumber;this.game.loadLevel(this.levels[levelNumber]);return true;},append:function(levels){newLevels=[];if(typeof(levels)==='object'){if(levels.constructor===(new Array).constructor){newLevels=levels;}else{newLevels[0]=levels;}
this.levels=this.levels.concat(newLevels);return true;}else{return false;}},getCurrent:function(){return this.levels[this.currentLevel];}});});

// lib/game/controllers/playerController.js
ig.baked=true;ig.module('game.controllers.playerController').requires('impact.impact').defines(function(){ig.playerController=ig.Class.extend({position:{x:null,y:null},player:null,init:function(){this.defaults={position:this.position}},addPlayer:function(playerEntity){if(!this.position.x){this.position.x=playerEntity.pos.x;this.position.y=playerEntity.pos.y;}
this.player=playerEntity;this.player.pos.x=this.position.x;this.player.pos.y=this.position.y;},updatePosition:function(x,y){this.position.x=x;this.position.y=y;}})})

// lib/game/main.js
ig.baked=true;ig.module('game.main').requires('impact.game','impact.debug.debug','impact.font','game.levels.qubmap','game.levels.mainMenu','game.entities.qubber','game.entities.house','game.entities.qubapp','game.controllers.sceneController','game.controllers.playerController').defines(function(){MyGame=ig.Game.extend({font:new ig.Font('media/04b03.fontblack.png'),bigfont:new ig.Font('media/04b03.fontblackx3.png'),biggerfont:new ig.Font('media/04b03.fontblackx5.png'),name:"Quber",clearColor:'#333333',player:null,phone:null,STATE:{MAINMENU:0,PLAYMODE:1,APPMODE:2,MINIGAME:3},init:function(){ig.input.bind(ig.KEY.LEFT_ARROW,'left');ig.input.bind(ig.KEY.RIGHT_ARROW,'right');ig.input.bind(ig.KEY.UP_ARROW,'up');ig.input.bind(ig.KEY.DOWN_ARROW,'down');ig.input.bind(ig.KEY.A,'left');ig.input.bind(ig.KEY.D,'right');ig.input.bind(ig.KEY.W,'up');ig.input.bind(ig.KEY.S,'down');ig.input.bind(ig.KEY.J,'pause');ig.input.bind(ig.KEY.Q,'app');ig.input.bind(ig.KEY.ENTER,'enter');ig.input.bind(ig.KEY.MOUSE1,'leftMouse');ig.input.bind(ig.KEY.MOUSE2,'rightMouse');window.onresize=this.onresize;this.currentState=this.STATE.MAINMENU;this.drawCoordinates={main:{x:ig.system.width/2,y:ig.system.height/2-50},score:{x:5,y:5},profile:{x:5,y:window.innerHeight/2-30}}
this.sceneController=new ig.sceneController(this,[LevelMainMenu,LevelQubmap])
this.playerController=new ig.playerController();},onresize:function(event){var width=Math.floor(window.innerWidth/ig.system.scale);var height=Math.floor(window.innerHeight/ig.system.scale);ig.system.resize(width,height);ig.game.drawCoordinates={main:{x:ig.system.width/2,y:ig.system.height/2-50},score:{x:5,y:5},profile:{x:5,y:window.innerHeight/2-30}}},changeState:function(newState){this.currentState=newState;switch(this.currentState){case this.STATE.PLAYMODE:this.sceneController.loadLevel(1);this.player=ig.game.getEntitiesByType(EntityQubber)[0];this.playerController.addPlayer(this.player);this.phone=ig.game.spawnEntity(EntityQubapp,ig.system.width,0);break;case this.STATE.MAINMENU:this.sceneController.loadLevel(0);break;}},loadLevel:function(data){this.parent(data);},update:function(){this.parent();switch(this.currentState){case this.STATE.PLAYMODE:this.playerController.updatePosition(this.player.pos.x,this.player.pos.y);var currentmap=ig.game.backgroundMaps[0];this.screen.x=(this.player.pos.x-ig.system.width/2).limit(0,currentmap.width*currentmap.tilesize-ig.system.width);this.screen.y=(this.player.pos.y-ig.system.height/2).limit(0,currentmap.height*currentmap.tilesize-ig.system.height);this.phone.pos.x=this.screen.x+ig.system.width-this.phone.size.x;this.phone.pos.y=this.screen.y;if(ig.input.state('pause')){this.changeState(this.STATE.MAINMENU);}
if(ig.input.state('app')){}
break;case this.STATE.MAINMENU:this.screen.x=0;this.screen.y=0;if(ig.input.state('enter')){this.changeState(this.STATE.PLAYMODE);}
break;default:break;break;}},draw:function(){this.parent();switch(this.currentState){case this.STATE.PLAYMODE:this.player.draw();this.phone.draw();this.font.draw('Q: '+this.player.money,this.drawCoordinates.score.x,this.drawCoordinates.score.y,ig.Font.ALIGN.LEFT);this.font.draw('Press J to pause',this.drawCoordinates.profile.x,this.drawCoordinates.profile.y,ig.Font.ALIGN.LEFT);ig.log()
break;case this.STATE.MAINMENU:this.biggerfont.draw(this.name,this.drawCoordinates.main.x,this.drawCoordinates.main.y,ig.Font.ALIGN.CENTER);this.bigfont.draw('Press Enter to start',this.drawCoordinates.main.x,this.drawCoordinates.main.y+50,ig.Font.ALIGN.CENTER);break;default:break;break;}}});var scale=2;var width=Math.floor(window.innerWidth/scale);var height=Math.floor(window.innerHeight/scale);ig.main('#canvas',MyGame,60,width,height,scale);});